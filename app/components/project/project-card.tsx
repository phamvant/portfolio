...
export function ProjectCard({ project }: { project: ProjectInfo }) {
  return (
    <div
      className="w-full border-[1px] max-h-80 group relative flex flex-col dark:bg-slate-900/50
        rounded-xl shadow-md hover:shadow-2xl overflow-hidden transition-all duration-300 h-full"
    >
      <img
        src={project.imgUrl}
        alt="Post Image"
