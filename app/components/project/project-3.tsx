      ...
      <div className="project-1 py-32 md:py-52 w-full flex flex-wrap gap-40 lg:gap-10 *:min-w-[300px] *:flex-1 md:px-[5%] xl:px-[20%] bg-white">
        ...
        <div className="relative group *:lg:hover:scale-[75%] *:absolute *:left-10 *:rounded-2xl *:shadow-2xl *:transition-all *:duration-300 pb-64">
          ...
          <img
            ...
            className="w-3/4 lg:w-full lg:group-hover:-translate-y-52 lg:group-hover:-translate-x-44"
          />
          <img
            src="/project/dreamhacker/2.jpg"
            className="w-3/4 lg:w-full object-cover translate-x-5 lg:translate-x-10 -translate-y-10 lg:group-hover:-translate-y-52 lg:group-hover:translate-x-80"
          />
          <img
            src="/project/dreamhacker/1.jpg"
            className="w-3/4 lg:w-full object-cover translate-x-10 lg:translate-x-20 -translate-y-20 lg:group-hover:-translate-y-56"
          />
        </div>
      </div>
